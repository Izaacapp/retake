...
python fish-speech/tools/api_client.py \
  ...
  --reference_audio data/source/GMT20251114-035710_Recording.m4a \
...
python fish-speech/tools/api_client.py \
  ...
  --reference_audio data/source/GMT20251114-025308_Recording.m4a \
...
python fish-speech/tools/api_client.py \
  ...
  --reference_audio output/speakers/jules/voice_samples/jules_000.wav \
...
python fish-speech/tools/api_client.py \
  ...
  --reference_audio output/speakers/aaron/voice_samples/aaron_000.wav \
